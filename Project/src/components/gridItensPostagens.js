...
export default function GridItensPostagens({
  data,
  state = false,
  btnText = "ver todas postagens",
}) {
  ...
  return (
    <>
      <h1 className="flex m-auto my-0 text-5xl font-bold md:text-4xl mt-10 sml:text-3xl text-center">
        Tecnolgias informativos e outros
      </h1>
      <span className="m-auto my-5 text-xl opacity-70 mt-3 sml:px-5 text-justify">
        Explore paginas de tecnologias abaixo e veja magnificos desenvolvidos
      </span>
